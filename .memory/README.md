...
| `decisions.md` | سجلّ القرارات المعمارية **D-001 → D-296** — كل قرار بسرده وجذره ودليله الحيّ. أحدثها: **D-296** (إلغاءُ حصر السبعة — السوق وحده هو الشرط) · **D-295** (CPN — الانتقالُ مبادلةٌ لا توفير) · **D-294** (لا إجازةَ ببوّاباتٍ لم تُشغَّل) · **D-292** (AHW) |
