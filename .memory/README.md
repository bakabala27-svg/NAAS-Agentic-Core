...
| `decisions.md` | سجلّ القرارات المعمارية **D-001 → D-295** — كل قرار بسرده وجذره ودليله الحيّ. أحدثها: **D-295** (CPN — رسمُ المسار: الانتقالُ مبادلةٌ لا توفير) · **D-294** (لا إجازةَ ببوّاباتٍ لم تُشغَّل) · **D-292** (AHW) |
