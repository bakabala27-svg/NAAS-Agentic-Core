...
| `decisions.md` | سجلّ القرارات المعمارية **D-001 → D-291** — كل قرار بسرده وجذره ودليله الحيّ. أحدثها: **D-291** (الدفعة الثالثة من البحث المستقل: CND/LID أداةٌ لا معيار · جولةُ قرار 02 بحدٍّ أقصى E1 · فارضٌ يشتقّ أرقام الأداة من ملفّ القياس) · **D-290** (دستور اعتمادية الوكلاء والعملة الصعبة) · **D-289** (الحارسُ أستاذٌ لا رقابة). | سجلّ ملزِم |
