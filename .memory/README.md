...
| `decisions.md` | سجلّ القرارات المعمارية **D-001 → D-294** — كل قرار بسرده وجذره ودليله الحيّ. أحدثها: **D-292** (الدفعة الرابعة من البحث المستقل: AHW — نافذةُ صلاحية الضمان · جولةُ قرار 03 عند E1 · سجلُّ ادعاءاتٍ بـ20 سنداً) · **D-291** (الدفعة الثالثة: CND/LID) · **D-290** (دستور اعتمادية الوكلاء) |
...
| `assurance_window_truth.md` | **حالة** AHW — نافذةُ صلاحية الضمان (D-292، وتصحيحٌ في نفسِ اليوم D-293، ودرسُ الإجازةِ المحليّة D-294) — AW1–AW9 · ε=1.264796 · نافذةٌ صلبة 8.85 يوماً · محورُ الاستقلال `adjudicate` + ممرُّ 731 يوماً · صفرُ تشغيلِ نموذج · الآجالُ الناجية {30·45·60·90} |
