...
| [`commercial/SOVEREIGN_KNOWLEDGE_REVENUE_MAP.md`](commercial/SOVEREIGN_KNOWLEDGE_REVENUE_MAP.md) | 🗺️ **الخارطة السيادية لتوليد المعرفة وبناء الإيرادات الدولية للمشروع** — الوثيقة المرجعية الرئيسية ونظام التشغيل الفكري والاستراتيجي: جرد الأصول، سجل نقاط الضعف، مصفوفة النواقص والمهام، مسارات الإيراد الـ8 وتفريعاتها الـ71، بطاقات التقييم، سجل المعرفة الجديدة K-01→K-08، وخارطة التنفيذ المرحلية من الوضع الراهن إلى أول إيراد ودخل متكرر |
| [`commercial/ASSET_KNOWLEDGE_AND_REVENUE_MAP.md`](commercial/ASSET_KNOWLEDGE_AND_REVENUE_MAP.md) · [`governance/ASSET_LICENSE_CLEARANCE.json`](governance/ASSET_LICENSE_CLEARANCE.json) · [`adr/ADR-017-asset-license-clearance.md`](adr/ADR-017-asset-license-clearance.md) | 🧾 **طبقةُ التدقيق المُشتَقّة: براءةُ الأصول المقروءةُ من المنبع، وجردُ ما يُمكِنُ بيعُه فعلاً، وفرصُ الإيراد العشرُ بمعايير منطوقة، وخطةُ أول عملية بيع** — تجيبُ عن الأسئلة الاثني عشر بأدلّةٍ تُعادُ إنتاجُها بثلاثة أوامر، وتُعلِنُ ما لم يُفحص في §15. تحرسُها `check_asset_license_clearance.py` و`check_commercial_offers_parity.py` (⛔ ليست مصدراً للحالة: الحالةُ في `.memory/runtime_truth.md`) |
| [`sovereign-atlas/README.md`](sovereign-atlas/README.md) | 🇩🇿 **الأطلس السيادي الشامل لأصول الجزائر ومسارات تحويلها إلى قيمة مضافة وإيرادات دولية** — مرجع بحثي حي (20 ملفاً موسوماً بدرجات ثقة FACT→MISSING): بطاقات 58 ولاية، 14 مسحاً قطاعياً (مناجم/محروقات/طاقة/غذاء/بحر/صحراء/صناعة/رقمي/سياحة)، أسواق وHS، المسار القانوني-المالي لتحصيل العملة، نموذج ترتيب /100 بنفس الأوزان المعلنة، نماذج مالية بثلاثة سيناريوهات، خطة 72س/30/90/سنة/5-10س، المخرجات الإلزامية الـ15 المرقّمة، وسجلات الفجوات/المخاطر/القوانين/المصادر؛ بروتوكول وكلاء إلزامي 12 قاعدة وسجل قرارات AD-01→AD-05 |
...
| [`commercial/MARKET_FIRST_SALES_REALITY_PROMPT.md`](commercial/MARKET_FIRST_SALES_REALITY_PROMPT.md) | 🧭 **برومبت الاستكشاف من السوق أولًا** — تصحيح نطاق المهمة: خريطة ما يُباع فعليًا (Sales Reality Map) ثم مصفوفة المطابقة مع قدراتنا؛ ثلاث فئات (موجود/قابل للتكييف/جديد تمامًا)؛ سجل الفرص الخارجية `EXT-###` خارج السبعة للبحث دون التزام (⛔ الخط الثامن يتطلب ADR + قرار مالك)؛ صيغة القرار النهائي بسبع حالات `CAN_SELL_*` |
...
| [`research/HARD_CURRENCY_NEW_KNOWLEDGE_AHW.md`](research/HARD_CURRENCY_NEW_KNOWLEDGE_AHW.md) · [`research/FRONTIER_CLAIM_LEDGER_2026-09.md`](research/FRONTIER_CLAIM_LEDGER_2026-09.md) · [`research/AHW_MEASUREMENTS.json`](research/AHW_MEASUREMENTS.json) · [`commercial/AHW_EXPORT_OFFER.md`](commercial/AHW_EXPORT_OFFER.md) · [`../.memory/assurance_window_truth.md`](../.memory/assurance_window_truth.md) · [`../shared/research/assurance_window.py`](../shared/research/assurance_window.py) | 🔬 **الدفعة الرابعة من البحث المستقل (D-292)** — AHW: **كم يعيش رقمُ الاطمئنان؟** أُسُّ أفقٍ محسوب (ε=1.264796 ⇒ 8× أفق = 13.87× تعرّض) · منحنى اطمئنان/ميزانيةِ خصم (138.24 محاولةً لكل نقطة؛ ⛔ لا يُشترى «رقمٌ أعلى» بميزانيةٍ أكبر) · نافذةُ ضمانٍ بحدَّين (6.02 يوماً عند ±2 نقطة · صلبةٌ 8.85 يوماً) · دورةٌ تقويمية يسبقُها الإصدار باحتمال 65.75% ⇒ **وحدةُ البيع حدثٌ لا سنة** · دبوسُ تقريرٍ بستةِ حقول (FRESH/THROTTLED/STALE/UNPINNED) · قيدُ عقدٍ تنظيميٌّ ناجٍ تحت المرجعَين معاً {30·45·60·90} يوماً. ⛔ صفرُ تشغيلِ نموذج · ⛔ لا خطَّ ثامناً · ⛔ لا رقمَ إيراد · **D-293**: 28 سنداً (S46–S73) اختبارتُها 100 خضراء · ومحرَّكُ استقلاليةٍ `adjudicate` + ممرُّ 731 يوماً |
| [`research/HARD_CURRENCY_NEW_KNOWLEDGE_VBT.md`](research/HARD_CURRENCY_NEW_KNOWLEDGE_VBT.md) · [`research/VBT_MEASUREMENTS.json`](research/VBT_MEASUREMENTS.json) | 🔬 **الدفعة السابعة من البحث المستقل (2026-09-13)** — VBT: **حدود المُتحقِّق** — ثلاثية الأسبوع (OAI-HF · نافير–ستوكس · مقال أمودي) بمعماريةٍ واحدة والمُتحقِّق حاسمٌ وحيد · مقياس VGR (0.1619/0.1932) فرضيةً موسومةً H9 ببروتوكول دحض · إعادةُ تأطيرٍ سياساتية 🟡 (تغطية المُتحققات قبل الوتيرة) · مسودةُ تصنيف إجراءات حوادث الوكلاء v0.1 · قناة التأمين [S110] داخل الخطّ 6 لا خارجه. ⛔ صفرُ تشغيلِ نموذج · ⛔ لا خطَّ ثامناً · ⛔ لا رقمَ إيراد · التسجيل الدستوري محجوزٌ للمالك (T68) |
| [`research/HARD_CURRENCY_NEW_KNOWLEDGE_WOD.md`](research/HARD_CURRENCY_NEW_KNOWLEDGE_WOD.md) · [`research/WOD_MEASUREMENTS.json`](research/WOD_MEASUREMENTS.json) · [`commercial/WOD_BUYER_LAYER_OFFER.md`](commercial/WOD_BUYER_LAYER_OFFER.md) · [`../.memory/withholding_onboarding_truth.md`](../.memory/withholding_onboarding_truth.md) · [`../shared/research/withholding_onboarding.py`](../shared/research/withholding_onboarding.py) | 🔬 **الدفعة الثامنة من البحث المستقل (2026-09-14)** — WOD: **طبقةُ المشتري** — الاستقطاعُ يتبع وصفَ العقد لا جودةَ العمل: انقلابٌ محسوب (US: خدمةٌ خارج أراضيها 0% ↔ ترخيصٌ 30% ⇒ تعويضٌ مطلوب **+42.86%** · فرنسا **33⅓%** (م182 CGI) وإسبانيا **24%** على الخدمة نفسها · ألمانيا 15.83% ترخيصاً فقط ⇒ 10% بالمعاهدة · كندا 15% إن أُدّيت الخدمةُ على أراضيها) · **18/22** خلية قابلة للاقتباس و4 **ممنوعة** بسببٍ منطوق بلا متوسطات · **الفتح: جهد 5 وحدات ⇒ ثلاث فئات** (UK · DE · CA) وسلّمُ مرجعٍ يمنع الفاتورة الأولى على فئةٍ تشترط مرجعاً · A9 وسيط MoR `BLOCKED_DOCTRINE` (K5 + خرق سقف 120 يوماً) · K1–K5 لم تُطلق على البيانات المُعلنة. ⛔ صفرُ عقد · ⛔ لا خطَّ ثامنَ في الكتالوج · ⛔ لا رقمَ إيراد |
| [`research/HARD_CURRENCY_NEW_KNOWLEDGE_FIV.md`](research/HARD_CURRENCY_NEW_KNOWLEDGE_FIV.md) · [`research/FIV_MEASUREMENTS.json`](research/FIV_MEASUREMENTS.json) · [`../shared/research/first_invoice.py`](../shared/research/first_invoice.py) · [`../studies/algeria-hard-currency/DECISION-ROUND-06.md`](../studies/algeria-hard-currency/DECISION-ROUND-06.md) | 🔬 **الدفعة العاشرة من البحث المستقل (2026-09-15)** — FIV: **التحققُ من الفاتورة الأولى** — تعريفٌ مُعرَّف لا مُفترَض (C1–C3) + سقفُ FIV ($0 + ≤5 أيام): ترتيبٌ مُشتَقّ CH1←CH2←CH3←CH5←CH4 · **صافٍ واحد قابلٌ للاقتباس** ($800/$1k مسبار) ومنعُ نقل الرسم كوداً (`FeeScheduleMissingError`) ونصّاً · نطاقُ القوائم 18000–65000 ونطاقُ التدقيق 8000–150000 · تسوية 2/5 · **21/21** رقماً في §4 مطابقةٌ للملفّ الحتمي · H70–H79 (8 مُنجَزة · 1 جزئية · 1 معلّقة، E1 وحيدة = H71). ⛔ صفرُ عقدٍ مُبرَم (NOT FOUND) · ⛔ صفرُ إيراد · ⛔ المكافأةُ ليست عميلاً (D-267) |
